          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="flex justify-end">
                <Link href="/forgot-password" className="text-xs mt-2 text-slate-500 hover:underline">
                  Forgot password?
                </Link>
              </div>
            </div>
            <Button className="w-full bg-slate-900 h-11" onClick={handleCredsLogin} disabled={isLoading}>
